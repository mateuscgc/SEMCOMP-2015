...
<body>
   ...
   <main>
       <div class="content overlay-content">
            ...
            <div class="day-trigger col-md-2 col-sm-4 col-xs-6 col-sm-offset-2">
                <h2>02/09</h2>
                <span>Quarta-Feira</span>
            </div>
            <div class="day-trigger col-md-2 col-sm-4 col-xs-6 col-sm-offset-0">
                <h2>03/09</h2>
                <span>Quinta-Feira</span>
            </div>
            <div class="day-trigger col-md-2 col-sm-4 col-xs-6 col-md-offset-0 col-sm-offset-2 ">
                <h2>04/09</h2>
